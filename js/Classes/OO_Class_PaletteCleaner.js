...
OO.PaletteCleaner = function(_S){
    ...
    function PAL_Remove_All_Unused_Colors_And_Palettes()
    {
        ...
        {	
            var userHitOK = pf.confirmBox( "", "all" );
            if( !userHitOK ){ return; }
        }
        ...
        Action.perform( "onActionCleanPaletteLists()", "paletteView" );
        scene.endUndoRedoAccum();	
    }

    this.Remove_All_Unused_Colors_And_Palettes = function(){
